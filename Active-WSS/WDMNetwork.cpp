								  ...
								  UINT nW, LINK_COST hCost, UINT nLinkCap, float nLength)  
{
	...
	UniFiber *pUniFiber = new UniFiber(nFiberId, (OXCNode*)lookUpNodeById(nSrc),
			(OXCNode*)lookUpNodeById(nDst), hCost, nLength, nW, nLinkCap);
...
void WDMNetwork::setChannelCapacity(double nCapacity)
{
...
//LA:between ness centrality calculated considering sp between all node pairs
//void WDMNetwork::setBetweennessCentrality(Graph&m_hGraph)
//{
//	vector<OXCNode*>::const_iterator itr;
...
//		Vertex* pVDst = m_hGraph.lookUpVertex(pNetNode2->getId(), Vertex::VT_Access_In, -1);
//		for (itrNode = this->m_hNodeList.begin(); itrNode != this->m_hNodeList.end(); itrNode++)
//		{
//			pNetNode = (OXCNode*)(*itrNode);
//
...
//					{
//						
//						pOXCSrc=((Vertex*)(pLink->getSrc()))->m_pOXCNode;
//						pOXCDst=((Vertex*)(pLink->getDst()))->m_pOXCNode;
//						
...
//LA:function for the lighter version of DVNF
