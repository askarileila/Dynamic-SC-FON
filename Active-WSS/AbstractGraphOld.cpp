												  ...
												  AbstractNode *pDst,AbstractNode *pSrc)
{
	bool First=true;
	int WLSelected=-1;
	list<AbstractLink*>::const_iterator itr, itrhPath;
	list<AbstractNode*>::const_iterator itrNode;
	vector <int> WlsTried;
...
CheckWl:	//AbstractNode* DstN=hPath.front()->getDst();
			...
			#endif*/
			/*
				if(hPath.size()>0&&((Vertex*)hPath.front()->getSrc())->m_pOXCNode!=((Vertex*)pPrevLink->getDst())->m_pOXCNode)
					cin.get();*/
	...
	/*		else
	 ...
	 Updated=false;
				...
				if(((Vertex*)pPrevLink->m_pDst)->m_pOXCNode->costi[WLSelected]<UNREACHABLE)
					 pLink=(SimplexLink*)((Vertex*)pPrevLink->m_pDst)->m_pOXCNode->prev[WLSelected];
//				else{
//					 done=false;
//					if(((Vertex*)pPrevLink->m_pDst)->m_pOXCNode->costi[WLSelected]==UNREACHABLE)
...
//					#ifdef DEBUGLA
//						cout << "\n Before getting input links of pPrevlink"<<endl;
//					#endif
//	
...
//							}
//						}
//							//LA:look for other m_hIlinklist of dst
//						
//					if(!done){
//							for(itrNode=m_hNodeList.begin();itrNode!=m_hNodeList.end();itrNode++){
//								CandVertex=(Vertex*)((AbstractNode*)(*itrNode));
//								if(CandVertex->m_nChannel==WLSelected && CandVertex->m_pOXCNode==((Vertex*)pPrevLink->m_pDst)->m_pOXCNode && CandVertex->m_eVType==Vertex::VT_Channel_In && CandVertex->m_pPrevLink){
...
//								pLink = (SimplexLink*)(*itr);
//								if(find(TriedPaths.begin(),TriedPaths.end(),pLink)==TriedPaths.end()&&pLink->m_bValid&&pLink->m_nChannel==WLSelected)
//								{
...
//						for(itrNode=m_hNodeList.begin();itrNode!=m_hNodeList.end();itrNode++){
//								CandVertex=(Vertex*)((AbstractNode*)(*itrNode));
//								if(CandVertex->m_nChannel==WLSelected && CandVertex->m_pOXCNode==((Vertex*)pDst)->m_pOXCNode && CandVertex->m_eVType==Vertex::VT_Channel_In && CandVertex->m_pPrevLink){
//									pLink=(SimplexLink*)CandVertex->m_pPrevLink;
//									if(find(TriedPaths.begin(),TriedPaths.end(),pLink)==TriedPaths.end()){
//										done=true;
//										break;
...
Updating:				if(!Updated){
	...
	if(hPath.size()==0 && pDst->m_hCost!=0)
		return UNREACHABLE;
			...
			cout << "\n CHECK PATH"<<endl;
		#endif
CheckhPath:	if(hPath.size()!=0 &&(( ((Vertex*)hPath.back()->getDst())->m_pOXCNode!=((Vertex*)pDst)->m_pOXCNode)||(((Vertex*)hPath.front()->getSrc())->m_pOXCNode!=((Vertex*)pSrc)->m_pOXCNode))){
