...
public:
	...
	void Unprotected_setUpLightpath(NetMan*, Circuit*,bool); //LA:to support reprovision
	void updateSimplexLinkLpCapacity(Lightpath*, NetMan * , double,bool );//LA:to support reprovision
