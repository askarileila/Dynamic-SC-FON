...
public:
	...
	//LA:changed from bwgranularity to double type
	Circuit(double, CircuitType, Circuit*);
	~Circuit();
	...
	void Unprotected_setUpCircuit(NetMan * pNetMan,bool); //LA: to support reprovision
	void tearDownCircuit(NetMan * pNetMan, bool bLog = true);
...
public:
	...
	double					m_eBW; //LA:replaced the line below
