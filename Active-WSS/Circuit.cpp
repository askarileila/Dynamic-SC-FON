...
Circuit::Circuit(double eBW, CircuitType eCT, Circuit *pCircuit):
...
void Circuit::Unprotected_setUpCircuit(NetMan* pNetMan,bool tempReprov)
{
#ifdef DEBUGB
	cout << "-> Unprotected_setUpCircuit" << endl;
#endif // DEBUGB
	...
	{
		// --------------------- LIGHTPATH SETUP ---------------------
		(*itr)->Unprotected_setUpLightpath(pNetMan, this,tempReprov);
	}
...
void Circuit::tearDownCircuit(NetMan* pNetMan, bool bLog)
{
#ifdef DEBUGB
