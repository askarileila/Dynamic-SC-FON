...
public:
	UniFiber();
	UniFiber(UINT, OXCNode*, OXCNode*, LINK_COST, float, UINT, float,int);   //LA:added to support DC topology with link capacity //LA:updated to sup
	UniFiber(UINT, OXCNode*, OXCNode*, LINK_COST, float, UINT);	
	UniFiber(UINT, OXCNode*, OXCNode*, LINK_COST, float, UINT,int);	//LA:filterless	
	virtual ~UniFiber();
