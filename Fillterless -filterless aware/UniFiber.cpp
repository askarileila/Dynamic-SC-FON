...
AbstractLink(nId, pSrc, pDst, hCost, nLength , nNoOfChannels), 
...
//LA:added to support filterless tree
UniFiber::UniFiber(UINT nId, OXCNode *pSrc, OXCNode *pDst, 
				   LINK_COST hCost, float nLength, UINT nNoOfChannels, int tree):
	AbstractLink(nId, pSrc, pDst, hCost, nLength ,nNoOfChannels, tree), 
	m_nW(nNoOfChannels), m_pChannel(NULL),tree(tree)
{
	wlOccupation = valarray<LINK_COST>(1, nNoOfChannels); //CANALI VARIABILI
								//val,#elmts
	wlOccupationBCK = valarray<LINK_COST>(1, nNoOfChannels);
...
//LA:added to support DC toplolgy with capacity
UniFiber::UniFiber(UINT nId, OXCNode *pSrc, OXCNode *pDst, 
				   LINK_COST hCost, float nLength, UINT nNoOfChannels, float nLinkCap,int tree):
	AbstractLink(nId, pSrc, pDst, hCost, nLength , nLinkCap), 
	m_nW(nNoOfChannels), m_pChannel(NULL)
{
	wlOccupation = valarray<LINK_COST>(1, nNoOfChannels); //CANALI VARIABILI
								//val,#elmts
