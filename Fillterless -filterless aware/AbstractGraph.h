...
//	AbstractNode*		m_pPrevHop;			// previous node since there might be
	...
	/*list<Connection*>	m_ConsOnLP; //LA: connections using this link
	list<Connection*>	m_ConsToMove; //LA:connections that need to move from this link*/
...
public:
	...
	AbstractLink(int, AbstractNode*, AbstractNode*, LINK_COST, float , UINT,int); //LA:added to support link cap //LA:updated to support tree
	AbstractLink(int, AbstractNode*, AbstractNode*, LINK_COST, float , UINT); //LA:added to support link cap //LA:updated to support tree
	~AbstractLink();
	virtual void dump(ostream&) const;
	...
	double getCapacity() const;		//LA: added to return the capacity of each link
...
public:
	...
	double			m_linkCap;  //LA: link capacity in G
	vector<double>  m_linkCap_Array;	//LA:array of link capacity 
	int			LinkTree;
	vector<int>			FreeWl;
...
public:
	...
	AbstractLink* addLink(int, UINT, UINT, LINK_COST, float, float);  //LA:modified 
	AbstractLink* addLink(int, UINT, UINT, LINK_COST, float, float,int);  //LA:filterless tree
	...
	bool DVNF_updateLinkBW( Connection*); //LA: for the lighter version
	void DVNF_deprovLinkBW( Connection*); //LA: for the lighter version
	void DVNF_OccupyTree(int , int,int);
	void DVNF_ReleaseTree(int, int,int);
