...
public:
	...
	vector<int>			m_Src_WLs;//LA:array to keep src wl for connections that need to be moved
	vector<int>			m_Dst_WLs;//LA:array to keep dst wl for connections that need to be moved
	vector<int>			m_Loc_Wls;	//LA:array to keep location of wl
