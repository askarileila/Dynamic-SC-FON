...
template<class T, class Cont, class Pred>
const typename BinaryHeap<T, Cont, Pred>::value_type& BinaryHeap<T, Cont, Pred>::peekMax()
{
	return m_hContainer.back();
}

template<class T, class Cont, class Pred>
void BinaryHeap<T, Cont, Pred>::popMax()
{
